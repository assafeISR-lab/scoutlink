  ...
  return (
    <aside className="w-64 flex flex-col border-r border-white/5 flex-shrink-0" style={{
      ...
      <nav className="flex-1 px-4 py-6 flex flex-col gap-1 overflow-y-auto">
        ...
        <NavItem icon={<IconDatabase />} label="Players Watch List" color="#00c896" href="/databases" active={onDatabases} />
...
function IconScoutAI() { return <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2a2 2 0 0 1 2 2c0 .74-.4 1.38-1 1.72V7h1a7 7 0 0 1 7 7h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1h-1v1a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-1H2a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h1a7 7 0 0 1 7-7h1V5.72A2 2 0 0 1 10 4a2 2 0 0 1 2-2zm0 7a5 5 0 0 0-5 5v3h10v-3a5 5 0 0 0-5-5zm-2.5 5a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm5 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3z"/></svg> }
